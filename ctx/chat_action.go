...
func (ca *ChatAction) Timeout(duration time.Duration) *ChatAction {
	if ca.opts.RequestOpts == nil {
		ca.opts.RequestOpts = new(gotgbot.RequestOpts)
	}

	ca.opts.RequestOpts.Timeout = duration

	return ca
}

// APIURL sets a custom API URL for this request.
func (ca *ChatAction) APIURL(url String) *ChatAction {
	if ca.opts.RequestOpts == nil {
		ca.opts.RequestOpts = new(gotgbot.RequestOpts)
	}

	ca.opts.RequestOpts.APIURL = url.Std()
