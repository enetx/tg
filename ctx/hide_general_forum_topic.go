...
func (hgft *HideGeneralForumTopic) APIURL(url String) *HideGeneralForumTopic {
	if hgft.opts.RequestOpts == nil {
		hgft.opts.RequestOpts = new(gotgbot.RequestOpts)
	}
...
func (hgft *HideGeneralForumTopic) Send() Result[bool] {
	return ResultOf(hgft.ctx.Bot.Raw().HideGeneralForumTopic(
