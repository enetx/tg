...
func (emrm *EditMessageReplyMarkup) MessageID(id int64) *EditMessageReplyMarkup {
	emrm.messageID = Some(id)
	return emrm
}

// InlineMessageID sets the inline message ID to edit.
func (emrm *EditMessageReplyMarkup) InlineMessageID(id String) *EditMessageReplyMarkup {
	emrm.opts.InlineMessageId = id.Std()
	return emrm
}

// Business sets the business connection ID for the markup edit.
func (emrm *EditMessageReplyMarkup) Business(id String) *EditMessageReplyMarkup {
...
func (emrm *EditMessageReplyMarkup) APIURL(url String) *EditMessageReplyMarkup {
	if emrm.opts.RequestOpts == nil {
		emrm.opts.RequestOpts = new(gotgbot.RequestOpts)
	}
...
func (emrm *EditMessageReplyMarkup) Send() Result[*gotgbot.Message] {
	if emrm.kb != nil {
