...
func TestSetChatMenuButton_MenuButton(t *testing.T) {
	...
	if ctx.SetChatMenuButton().MenuButton(menuButton) == nil { t.Error("MenuButton should return builder") }
}

func TestSetChatMenuButton_DefaultMenu(t *testing.T) {
	bot := &mockBot{}
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 123, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	if ctx.SetChatMenuButton().DefaultMenu() == nil { t.Error("DefaultMenu should return builder") }
}
...
func TestSetChatMenuButton_WebAppMenu(t *testing.T) {
	...
	if ctx.SetChatMenuButton().WebAppMenu(g.String("Menu"), webApp) == nil { t.Error("WebAppMenu should return builder") }
}

func TestSetChatMenuButton_CommandsMenu(t *testing.T) {
	bot := &mockBot{}
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 123, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	if ctx.SetChatMenuButton().CommandsMenu() == nil { t.Error("CommandsMenu should return builder") }
}

func TestSetChatMenuButton_Timeout(t *testing.T) {
	bot := &mockBot{}
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 123, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	if ctx.SetChatMenuButton().Timeout(time.Minute) == nil { t.Error("Timeout should return builder") }
}

func TestSetChatMenuButton_APIURL(t *testing.T) {
	bot := &mockBot{}
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 123, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	if ctx.SetChatMenuButton().APIURL(g.String("https://api.example.com")) == nil { t.Error("APIURL should return builder") }
}
