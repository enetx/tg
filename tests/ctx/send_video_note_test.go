...
func TestSendVideoNote_After(t *testing.T) {
	...
	filename := g.String("videonote.mp4")
	if ctx.SendVideoNote(filename).After(time.Minute) == nil { t.Error("After should return builder") }
}
...
func TestSendVideoNote_DeleteAfter(t *testing.T) {
	...
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 456, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	filename := g.String("videonote.mp4")
	if ctx.SendVideoNote(filename).DeleteAfter(time.Hour) == nil { t.Error("DeleteAfter should return builder") }
}
...
func TestSendVideoNote_Markup(t *testing.T) {
	...
	if ctx.SendVideoNote(filename).Markup(keyboard.Inline().Button(btn1)) == nil { t.Error("Markup should return builder") }
}
...
func TestSendVideoNote_Thumbnail(t *testing.T) {
	...
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 456, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	filename := g.String("videonote.mp4")
	if ctx.SendVideoNote(filename).Thumbnail(g.String("thumb.jpg")) == nil { t.Error("Thumbnail should return builder") }
}
...
func TestSendVideoNote_ReplyTo(t *testing.T) {
	...
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 456, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	filename := g.String("videonote.mp4")
	if ctx.SendVideoNote(filename).ReplyTo(123) == nil { t.Error("ReplyTo should return builder") }
}
...
func TestSendVideoNote_Business(t *testing.T) {
	...
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 456, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	filename := g.String("videonote.mp4")
	if ctx.SendVideoNote(filename).Business(g.String("biz_123")) == nil { t.Error("Business should return builder") }
}
...
func TestSendVideoNote_Thread(t *testing.T) {
	...
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 456, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	filename := g.String("videonote.mp4")
	if ctx.SendVideoNote(filename).Thread(456) == nil { t.Error("Thread should return builder") }
}
