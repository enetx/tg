...
func TestSetUserEmojiStatus_EmojiStatusCustomEmojiID(t *testing.T) {
	...
	userID := int64(456)
	if ctx.SetUserEmojiStatus(userID).EmojiStatusCustomEmojiID(g.String("emoji_123")) == nil { t.Error("EmojiStatusCustomEmojiID should return builder") }
}
...
func TestSetUserEmojiStatus_RemoveStatus(t *testing.T) {
	...
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 123, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	userID := int64(456)
	if ctx.SetUserEmojiStatus(userID).RemoveStatus() == nil { t.Error("RemoveStatus should return builder") }
}
...
func TestSetUserEmojiStatus_EmojiStatusExpirationDate(t *testing.T) {
	...
	if ctx.SetUserEmojiStatus(userID).EmojiStatusExpirationDate(expirationDate) == nil { t.Error("EmojiStatusExpirationDate should return builder") }
}
...
func TestSetUserEmojiStatus_ExpiresAt(t *testing.T) {
	...
	if ctx.SetUserEmojiStatus(userID).ExpiresAt(expiresAt) == nil { t.Error("ExpiresAt should return builder") }
}
...
func TestSetUserEmojiStatus_ExpiresIn(t *testing.T) {
	...
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 123, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	userID := int64(456)
	if ctx.SetUserEmojiStatus(userID).ExpiresIn(time.Hour) == nil { t.Error("ExpiresIn should return builder") }
}
...
func TestSetUserEmojiStatus_APIURL(t *testing.T) {
	...
	ctx := ctx.New(bot, &ext.Context{EffectiveChat: &gotgbot.Chat{Id: 123, Type: "private"}, Update: &gotgbot.Update{UpdateId: 1}})
	userID := int64(456)
	if ctx.SetUserEmojiStatus(userID).APIURL(g.String("https://api.example.com")) == nil { t.Error("APIURL should return builder") }
}
