...
type Entities struct {
	entities Slice[gotgbot.MessageEntity]
	text     String
}
...
func New[T ~string](text T) *Entities {
	return &Entities{
		text:     String(text),
		entities: NewSlice[gotgbot.MessageEntity](),
	}
}

// Bold marks the first occurrence of sub as bold.
func (e *Entities) Bold(sub String) *Entities {
...
func (e *Entities) Italic(sub String) *Entities {
	return e.match(sub, func(offset, length int64) {
...
func (e *Entities) Underline(sub String) *Entities {
	return e.match(sub, func(offset, length int64) {
...
func (e *Entities) Strikethrough(sub String) *Entities {
	return e.match(sub, func(offset, length int64) {
...
func (e *Entities) Spoiler(sub String) *Entities {
	return e.match(sub, func(offset, length int64) {
...
func (e *Entities) Code(sub String) *Entities {
	return e.match(sub, func(offset, length int64) {
...
func (e *Entities) Pre(sub String, language ...String) *Entities {
	return e.match(sub, func(offset, length int64) {
...
func (e *Entities) URL(sub, url String) *Entities {
	return e.match(sub, func(offset, length int64) {
...
func (e *Entities) Mention(sub String, userID int64) *Entities {
	return e.match(sub, func(offset, length int64) {
		e.entities.Push(gotgbot.MessageEntity{
			Type:   "text_mention",
			Offset: offset,
...
func (e *Entities) CustomEmoji(sub, emojiID String) *Entities {
	return e.match(sub, func(offset, length int64) {
		e.entities.Push(gotgbot.MessageEntity{
			Type:          "custom_emoji",
			Offset:        offset,
...
func (e *Entities) Blockquote(sub String) *Entities {
	return e.match(sub, func(offset, length int64) {
...
func (e *Entities) ExpandableBlockquote(sub String) *Entities {
	return e.match(sub, func(offset, length int64) {
...
func (e *Entities) match(sub String, fn func(offset, length int64)) *Entities {
